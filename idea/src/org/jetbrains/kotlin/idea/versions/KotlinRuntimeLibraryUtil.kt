...
val DEPRECATED_LIBRARIES_INFORMATION = listOf(
        deprecatedLib(
                ...
                oldName = "kotlin-stdlib-jre7", newName = "kotlin-stdlib-jdk7",
                outdatedAfterVersion = "1.2.0-rc-39",
                message = "'kotlin-stdlib-jre7' is deprecated since 1.2.0 and should be replaced with 'kotlin-stdlib-jdk7'"),

        deprecatedLib(
                oldGroupId = "org.jetbrains.kotlin",
                oldName = "kotlin-stdlib-jre8", newName = "kotlin-stdlib-jdk8",
                outdatedAfterVersion = "1.2.0-rc-39",
                message = "'kotlin-stdlib-jre8' is deprecated since 1.2.0 and should be replaced with 'kotlin-stdlib-jdk8'")
)