...
val x1 = Num<<!NI;UPPER_BOUND_VIOLATED!><!UPPER_BOUND_VIOLATED!>String<!><!>>("")
...
val y1 = TColl<Any, <!NI;UPPER_BOUND_VIOLATED!><!NI;UPPER_BOUND_VIOLATED!><!UPPER_BOUND_VIOLATED!>Any<!><!><!>>()
