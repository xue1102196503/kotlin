...
class MyDerived : MyClass(1.0) {
    val test4 = <!NI;NONE_APPLICABLE!><!INVISIBLE_MEMBER!>MyAlias<!><!>(1)
    val test4a = <!NI;NONE_APPLICABLE!><!INVISIBLE_MEMBER!>MyClass<!><!>(1)
    val test5 = <!NI;PROTECTED_CONSTRUCTOR_NOT_IN_SUPER_CALL!><!PROTECTED_CONSTRUCTOR_NOT_IN_SUPER_CALL!>MyAlias<!><!>("")
