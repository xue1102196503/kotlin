...
abstract class A<T> {
    ...
    public inner abstract class B<S> : A<B<S>>() {
        public inner <!NI;ABSTRACT_CLASS_MEMBER_NOT_IMPLEMENTED!><!ABSTRACT_CLASS_MEMBER_NOT_IMPLEMENTED!>class C<!><!><U> : <!NI;UNRESOLVED_REFERENCE_WRONG_RECEIVER!><!NI;DEBUG_INFO_UNRESOLVED_WITH_TARGET!>B<!><!><C<U>>()
        {
            ...
            <!NI;NOTHING_TO_OVERRIDE!><!NOTHING_TO_OVERRIDE!>override<!><!> fun foo(x: B<C<U>>)  {
