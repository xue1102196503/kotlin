...
fun foo2(a: A<out CharSequence>, b: A<in CharSequence>) {
    a.<!TYPE_INFERENCE_UPPER_BOUND_VIOLATED!>foo1<!>(<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>Out<CharSequence>()<!><!>)
    ...
    a.<!TYPE_INFERENCE_UPPER_BOUND_VIOLATED!>foo2<!>(<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>Inv<CharSequence>()<!><!><!>)
    ...
    b.<!TYPE_INFERENCE_UPPER_BOUND_VIOLATED!>foo2<!>(<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>Inv<CharSequence>()<!><!><!><!>)
    b.foo2<<!UPPER_BOUND_VIOLATED!>Inv<CharSequence><!>>(Inv())


    b.<!TYPE_INFERENCE_UPPER_BOUND_VIOLATED!>foo3<!>(<!NI;TYPE_MISMATCH!><!NI;TYPE_MISMATCH!>In<CharSequence>()<!><!>)
