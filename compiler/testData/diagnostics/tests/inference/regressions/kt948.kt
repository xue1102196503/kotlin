...
fun foo() {
    ...
    val <!NI;UNUSED_VARIABLE!><!UNUSED_VARIABLE!>l<!><!> : List<Int> = emptyList()!!
    <!NI;UNREACHABLE_CODE!>val <!NI;UNUSED_VARIABLE!><!UNUSED_VARIABLE!>l1<!><!> =<!> <!NI;TYPE_MISMATCH!><!TYPE_INFERENCE_NO_INFORMATION_FOR_PARAMETER!>emptyList<!>()<!>!!
