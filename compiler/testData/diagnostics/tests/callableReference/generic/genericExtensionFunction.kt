...
fun <T> test2() {
    ...
    bar<Wrapper, T, T>(<!NI;TYPE_MISMATCH!>Wrapper::<!TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!>fooReturnString<!><!>)
    bar<Wrapper, Int, Int>(<!NI;TYPE_MISMATCH!>Wrapper::<!TYPE_INFERENCE_EXPECTED_TYPE_MISMATCH!>fooReturnString<!><!>)
