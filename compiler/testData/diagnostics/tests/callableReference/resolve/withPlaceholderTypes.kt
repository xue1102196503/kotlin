...
val x4 = <!NI;OVERLOAD_RESOLUTION_AMBIGUITY!><!OVERLOAD_RESOLUTION_AMBIGUITY!>fn2<!><!>(::<!NI;DEBUG_INFO_MISSING_UNRESOLVED!><!OVERLOAD_RESOLUTION_AMBIGUITY!>foo<!><!>, ::<!NI;DEBUG_INFO_MISSING_UNRESOLVED!>bar<!>)
val x5 = <!NI;OVERLOAD_RESOLUTION_AMBIGUITY!><!OVERLOAD_RESOLUTION_AMBIGUITY!>fn2<!><!>(::<!NI;DEBUG_INFO_MISSING_UNRESOLVED!><!OVERLOAD_RESOLUTION_AMBIGUITY!>foo<!><!>, ::<!NI;DEBUG_INFO_MISSING_UNRESOLVED!><!OVERLOAD_RESOLUTION_AMBIGUITY!>foo<!><!>)
